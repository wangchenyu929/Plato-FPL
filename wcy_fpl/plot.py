...
def plot(x_label: str, x_value_list, y_label: str, y_value_list,figure_file_name: str):
    ...
    # #f8ac8c 橘色
    # #c82423 红
    ax.plot(x_value_list[0], y_value_list[0],color='#2878b5',label='iid')
    ax.plot(x_value_list[1], y_value_list[1],color='#c82423',label='noniid')
...
def main():
    ...
    result_csv_file1 =  './results/iid.csv'
    result_csv_file2 =  './results/noniid.csv'
